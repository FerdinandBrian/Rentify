<x-guest-layout>
    <div class="glass-card rounded-[2rem] p-8 border-black/5 relative overflow-hidden">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-slate-500 font-medium">Lengkapi data di bawah untuk mendaftar</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-5">
            ...
            <!-- Name -->
            <div class="space-y-2">
                <label for="name" class="text-sm font-black text-slate-500 uppercase tracking-widest ml-1">Nama Lengkap</label>
            ...
            <!-- Phone Number -->
            <div class="space-y-2">
                <label for="call_number" class="text-sm font-black text-slate-500 uppercase tracking-widest ml-1">Nomor Telepon</label>
                <div class="relative group">
                    <div class="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none text-slate-400 group-focus-within:text-orange-500 transition-colors">
                        <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="space-y-2">
                    <label for="password_confirmation" class="text-sm font-black text-slate-500 uppercase tracking-widest ml-1">Konfirmasi</label>
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none text-slate-400 group-focus-within:text-orange-500 transition-colors">
                            <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect>
        ...
        <div class="mt-8 text-center">
            <p class="text-slate-500 font-bold">
                Sudah punya akun? 
                <a href="{{ route('login') }}" class="text-slate-900 hover:text-orange-500 transition-colors border-b border-black/5 hover:border-orange-500/50 pb-0.5 ml-1">Masuk di sini</a>
            </p>
        </div>
    </div>
</x-guest-layout>
