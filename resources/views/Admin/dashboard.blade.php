            ...
            <div class="card card-round rentify-hero-card">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <span class="badge rentify-hero-badge mb-2">Admin Control Center</span>
                            <h2 class="fw-bold mb-1">Dashboard Operasional Rentify</h2>
                            <p class="mb-0">
                                Pantau pesanan, pendapatan, denda, dan status rental dari satu panel kontrol.
                            </p>
                        </div>
